...
git clone https://github.com/rothfels/gigly.git $SLUG
cd $SLUG
rm -rf .git

sed -i.bak "s/gigly/$SLUG/g" **/*.tf
sed -i.bak "s/gigly/$SLUG/g" **/*.ts
sed -i.bak "s/gigly/$SLUG/g" **/*.yml
sed -i.bak "s/gigly/$SLUG/g" **/*.sh
sed -i.bak "s/gigly/$SLUG/g" **/*.json
rm -rf **/*.bak
