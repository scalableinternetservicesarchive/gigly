...
usage="Usage: deploy-ecs.sh [gigly-app-web|gigly-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/gigly:$2"
...
aws ecs update-service --cluster gigly \
  --no-cli-pager \
  --region "$ecs_region" \
