...
resource "aws_ecs_cluster" "gigly" {
  name = "gigly"
}

resource "aws_ecr_repository" "gigly" {
  name                 = "gigly"
...
module "webserver" {
  ...
  ecr_repository = aws_ecr_repository.gigly.repository_url
  ecs_cluster    = aws_ecs_cluster.gigly.id
