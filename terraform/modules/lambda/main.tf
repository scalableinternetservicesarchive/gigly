...
# Lambda URIs are "{+lambda}/{+function}" e.g. "gigly/ping".
# We also support path matching at the root e.g. "gigly" but these require definining separate "_root" terraform resources.
